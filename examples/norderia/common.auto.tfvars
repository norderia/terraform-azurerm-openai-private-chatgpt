...
resource_group_name = "rg-bijukrishnan-LibreChat"
...
### 02 networking ###
virtual_network_name = "librechatgptvnet"
vnet_address_space   = ["10.3.0.0/24"]
subnet_config = {
  subnet_name                                   = "librechatgpt-sub"
...
### 05 cosmosdb ###
cosmosdb_name                    = "librechatgptcosmosdb"
...
# App Service Plan
app_service_name     = "librechatgptasp"
app_service_sku_name = "B1"

# LibreChat App Service
libre_app_name                          = "librechatgptchatapp"
...
libre_app_allowed_ip_addresses = [
  {
    ip_address = "0.0.0.0/0" # Allow all IPs (for librechat purposes)
    priority   = 200
...
# Server Config
libre_app_title         = "PRIVATE librechat CHATBOT"
libre_app_custom_footer = "Privately hosted GPT App powered by Azure OpenAI and LibreChat"
libre_app_host          = "0.0.0.0"
libre_app_port          = 80
libre_app_docker_image  = "ghcr.io/danny-avila/librechat-dev-api:6ccf4d6ed21c12621164f1782446eaa57d8bbabd" #v0.6.6 (Pre-release)
